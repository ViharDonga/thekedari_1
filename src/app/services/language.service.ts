...
export class LanguageService {
  ...
  private translations: Record<string, Record<SupportedLanguage, string>> = {
    ...
    'install_app_banner_title': { en: 'Install on your phone', hi: 'फ़ोन पर इंस्टॉल करें', gu: 'ફોન પર ઇન્સ્ટોલ કરો' },
    'install_app_banner_desc': { en: 'Add Thekedari to your home screen — works like an app, always shows the latest version.', hi: 'Thekedari को होम स्क्रीन पर जोड़ें — ऐप जैसा चलेगा, हमेशा नया वर्ज़न मिलेगा।', gu: 'Thekedari ને હોમ સ્ક્રીન પર ઉમેરો — એપ જેવું ચાલશે, હંમેશા નવું વર્ઝન મળશે.' },
    'install_app_now': { en: 'Install App', hi: 'ऐप इंस्टॉल करें', gu: 'એપ ઇન્સ્ટોલ કરો' },
    'install_app_steps_android': { en: 'Tap Chrome menu (⋮) at the top right → Add to Home screen or Install app.', hi: 'Chrome में ऊपर दाएँ मेनू (⋮) → Add to Home screen या Install app दबाएँ।', gu: 'Chrome માં ઉપર જમણે મેનૂ (⋮) → Add to Home screen અથવા Install app દબાવો.' },
    'install_app_steps_ios': { en: 'Tap Share in Safari → Add to Home Screen.', hi: 'Safari में Share दबाएँ → Add to Home Screen चुनें।', gu: 'Safari માં Share દબાવો → Add to Home Screen પસંદ કરો.' },
    'install_app_steps_desktop': { en: 'Use Chrome menu → Install Thekedari, or bookmark this page.', hi: 'Chrome मेनू → Install Thekedari, या इस पेज को बुकमार्क करें।', gu: 'Chrome મેનૂ → Install Thekedari, અથવા આ પેજ બુકમાર્ક કરો.' },
    'install_app_installed': { en: 'App installed — open from your home screen.', hi: 'ऐप इंस्टॉल हो गया — होम स्क्रीन से खोलें।', gu: 'એપ ઇન્સ્ટોલ થઈ — હોમ સ્ક્રીનથી ખોલો.' },
