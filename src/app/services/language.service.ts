...
export class LanguageService {
  ...
  private translations: Record<string, Record<SupportedLanguage, string>> = {
    ...
    'add_other_expense': { en: 'Add Other Expense', hi: 'अन्य खर्च जोड़ें', gu: 'અન્ય ખર્ચ ઉમેરો' },
    'edit_other_expense': { en: 'Edit Other Expense', hi: 'अन्य खर्च संपादित करें', gu: 'અન્ય ખર્ચ એડિટ કરો' },
    'other_expense_added': { en: 'Other expense added successfully', hi: 'अन्य खर्च जोड़ा गया', gu: 'અન્ય ખર્ચ ઉમેરાયો' },
    'other_expense_updated': { en: 'Other expense updated successfully', hi: 'अन्य खर्च अपडेट हो गया', gu: 'અન્ય ખર્ચ અપડેટ થયો' },
    'other_expense_validation': { en: 'Enter item name and amount greater than zero.', hi: 'आइटम नाम और राशि (शून्य से अधिक) दर्ज करें।', gu: 'આઇટમ નામ અને રકમ (શૂન્ય કરતાં વધુ) દાખલ કરો.' },
    'no_other_expenses': { en: 'No other expenses recorded yet.', hi: 'अभी कोई अन्य खर्च दर्ज नहीं।', gu: 'હજી કોઈ અન્ય ખર્ચ દાખલ નથી.' },
    'item_name': { en: 'Item / Material Name', hi: 'आइटम / सामग्री का नाम', gu: 'આઇટમ / સામગ્રીનું નામ' },
    'item_name_placeholder': { en: 'e.g. Diesel, Transport, Tools', hi: 'जैसे डीजल, परिवहन, औजार', gu: 'જેમ કે ડીઝલ, પરિવહન, સાધનો' },
    'amount': { en: 'Amount', hi: 'राशि', gu: 'રકમ' },
    'save': { en: 'Save', hi: 'सेव करें', gu: 'સાચવો' },
    'inactive': { en: 'Inactive', hi: 'निष्क्रिय', gu: 'નિષ્ક્રિય' },
    'inactive_records': { en: 'Inactive Records', hi: 'निष्क्रिय रिकॉर्ड', gu: 'નિષ્ક્રિય રેકોર્ડ' },
    'reactivate': { en: 'Reactivate', hi: 'फिर सक्रिय करें', gu: 'ફરી સક્રિય કરો' },
    'confirm_deactivate_expense': { en: 'Mark this expense as inactive? It will be removed from reports.', hi: 'इस खर्च को निष्क्रिय करें? यह रिपोर्ट से हट जाएगा।', gu: 'આ ખર્ચ નિષ્ક્રિય કરો? તે રિપોર્ટમાંથી દૂર થશે.' },
    'confirm_deactivate_rental': { en: 'Mark this rental as inactive? It will be removed from expense reports.', hi: 'इस किराए को निष्क्रिय करें? यह खर्च रिपोर्ट से हट जाएगा।', gu: 'આ ભાડું નિષ્ક્રિય કરો? તે ખર્ચ રિપોર્ટમાંથી દૂર થશે.' },
